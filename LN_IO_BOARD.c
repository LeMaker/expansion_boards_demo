...
void ioBoardLedTest()
{
	...
	printf("LED: the leds will all blink!\n");
...
/*
*	Function: ioBoardButtonTest
* Description: be used to test buttons on the board
*/
void ioBoardButtonTest()
{
	int pinLed;
	int cnt = 0;
	...
	pinLed = 0;
	printf("LED: the leds will be set to high!\n");

        for(pinLed=0; pinLed<LED_MAX_NUM; pinLed++)
	{
		digitalWrite(pinLed, HIGH);
        }
	printf("Button: press the buttons to set the led off!\n");
}
...
int main(int argc, char **argv)
{
	...
	else if (0 == strcasecmp(argv[1], "lcd"))
	{
        ...
        else if(0 == strcasecmp(argv[1], "button"))
        {
                ioBoardButtonTest();
        }
